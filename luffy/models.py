...
class CourseCategory(models.Model):
    """课程大类, e.g 前端  后端..."""
    name = models.CharField(max_length=64, unique=True,verbose_name="课程大类名")
...
class CourseSubCategory(models.Model):
    ...
    category = models.ForeignKey("CourseCategory",verbose_name="所属课程大类",on_delete=models.CASCADE)
...
class Scholarship(models.Model):
    """学位课程奖学金"""
    degree_course = models.ForeignKey("DegreeCourse",verbose_name="所属学位课程",on_delete=models.CASCADE)
...
class Course(models.Model):
    """专题课程 OR 学位课模块"""
    name = models.CharField(max_length=128, unique=True,verbose_name="课程名") # Python基础
    course_img = models.CharField(max_length=255)

    sub_category = models.ForeignKey("CourseSubCategory",verbose_name="所属学位奖学金",on_delete=models.CASCADE)

    course_type_choices = ((0, '付费'), (1, 'VIP专享'), (2, '学位课程'))
    course_type = models.SmallIntegerField(choices=course_type_choices)

    degree_course = models.ForeignKey("DegreeCourse",verbose_name="所属学位课程",blank=True, null=True, help_text="若是学位课程，此处关联学位表",on_delete=models.CASCADE)
    ...
    asked_question = GenericRelation("OftenAskedQuestion")
    class Meta:
        verbose_name_plural = "16:专题课程"


class CourseDetail(models.Model):
    """课程详情页内容"""
    course = models.OneToOneField("Course",verbose_name="所属课程",on_delete=models.CASCADE)
...
class CourseOutline(models.Model):
    """课程大纲"""
    course_detail = models.ForeignKey("CourseDetail",verbose_name="所属课程详情",on_delete=models.CASCADE)
...
class CourseChapter(models.Model):
    """课程章节"""
    course = models.ForeignKey("Course", related_name='coursechapters',verbose_name="所属课程",on_delete=models.CASCADE)
...
class CourseSection(models.Model):
    """课时目录"""
    chapter = models.ForeignKey("CourseChapter", related_name='coursesections',verbose_name="所属课程章节",on_delete=models.CASCADE)
    name = models.CharField(max_length=128)
...
class Homework(models.Model):
    chapter = models.ForeignKey("CourseChapter",verbose_name="所属课程章节",on_delete=models.CASCADE)
